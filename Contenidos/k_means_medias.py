...
# Intrucciones para graficar los clusters
...
plt.title("Clietes", fontsize=20)
plt.xlabel('Saldo en tu cuenta de ahorros (pesos)', fontsize=15)
plt.ylabel('Veces que usó su tarjeta de crédito', fontsize=15)
...
# Método del Codo
# Cálculo de número de Clusters (K)
